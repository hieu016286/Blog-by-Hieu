                                ...
                                @foreach ($comments as $c )
                                    <tr>
                                        <td>
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <p>{{ $c->comment }}</p>
                                                    <a target="_blank" href="{{ route('post.details',$c->post->slug.'#comments') }}">Reply</a>
                                                </div>
                                            </div>
                                        </td>
                                        <td>   
                                        ...
                                        <td>
                                            ...
                                            <form id="delete-form-{{ $c->id }}" method="POST" action="{{ route('admin.comment.destroy',$c->id) }}" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </td>
